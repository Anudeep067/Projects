...
char ssid[] = "RedmiNote9";
char pass[] = "anudeep111";
WiFiClient client;

unsigned long myChannelNumber = 1953541; //Your Channel Number (Without Brackets)
const char * myWriteAPIKey = "21QYBSHCAS6XMETD"; //Your Write API Key
